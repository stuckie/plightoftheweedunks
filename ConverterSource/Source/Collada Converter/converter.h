...
{
public:
	Light(DaeLight* dae_light) : m_dae_light(dae_light)
	{
	}

private:
	DaeLight* m_dae_light;
};

class Camera : public SceneNode
{
public:
	Camera(DaeCamera* dae_camera) : m_dae_camera(dae_camera)
	{
	}

private:
	DaeCamera* m_dae_camera;
};
...
private:
	...
	vector< SceneNode *>	_lights;
	vector< SceneNode *>	_cameras;
...
public:
	...
	void writePhysics ( ColladaDocument &doc,const string &name );
	void writeCameras ( ColladaDocument &doc,const string &name );
	void writeLights ( ColladaDocument &doc,const string &name );
	void writeLevel ( ColladaDocument &doc,const string &name );
};
