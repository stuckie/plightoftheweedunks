...
struct DaeNode
{
	...
	string					physicsObjectType;
	string					physicsShape;
	string					SpawnDelay;
	string					NumberofBert;
	string					NumberofErnie;
	string					waypointType;
	string					waypointAmount;
	...
	{
		joint = light = camera = helper = false;
		...
		while( !node1.isEmpty() && node1.getName() != 0x0 )
		{
			...
			if( strcmp( node1.getName(), "extra" ) == 0 )
			{
				XMLNode node2 = node1.getChildNode( "technique" );
				if( !node2.isEmpty() )
				{
					if( strcmp( node2.getAttribute( "profile", "" ), "MAYA" ) == 0 )
					{
						XMLNode node4 = node2.getChildNode( "dynamic_attributes" );
						if( !node4.getChildNode( "PhysicsMaterial" ).isEmpty() &&
							node4.getChildNode( "PhysicsMaterial" ).getText() != 0x0 )
								physicsMaterial = node4.getChildNode( "PhysicsMaterial" ).getText();

						if( !node4.getChildNode( "ObjectType" ).isEmpty() &&
							node4.getChildNode( "ObjectType" ).getText() != 0x0 )
								physicsObjectType = node4.getChildNode( "ObjectType" ).getText();

						if( !node4.getChildNode( "CollisionShape" ).isEmpty() &&
							node4.getChildNode( "CollisionShape" ).getText() != 0x0 )
								physicsShape = node4.getChildNode( "CollisionShape" ).getText();

						if( !node4.getChildNode( "NumberofBert" ).isEmpty() &&
							node4.getChildNode( "NumberofBert" ).getText() != 0x0 )
								NumberofBert = node4.getChildNode( "NumberofBert" ).getText();

						if( !node4.getChildNode( "NumberofErnie" ).isEmpty() &&
							node4.getChildNode( "NumberofErnie" ).getText() != 0x0 )
								NumberofErnie = node4.getChildNode( "NumberofErnie" ).getText();

						if( !node4.getChildNode( "SpawnDelay" ).isEmpty() &&
							node4.getChildNode( "SpawnDelay" ).getText() != 0x0 )
								SpawnDelay = node4.getChildNode( "SpawnDelay" ).getText();
						
						if( !node4.getChildNode( "Targetable" ).isEmpty() &&
							node4.getChildNode( "Targetable" ).getText() != 0x0 )
								targetable = node4.getChildNode( "Targetable" ).getText();

						if( !node4.getChildNode( "ErnieWayPoint" ).isEmpty() &&
							node4.getChildNode( "ErnieWayPoint" ).getText() != 0x0 )
								waypointType = "ErnieWayPoint", waypointAmount = node4.getChildNode( "ErnieWayPoint" ).getText();

						if( !node4.getChildNode( "BertWayPoint" ).isEmpty() &&
							node4.getChildNode( "BertWayPoint" ).getText() != 0x0 )
								waypointType = "BertWayPoint", waypointAmount = node4.getChildNode( "BertWayPoint" ).getText();

						if( !node4.getChildNode( "WeedunkWayPoint" ).isEmpty() &&
							node4.getChildNode( "WeedunkWayPoint" ).getText() != 0x0 )
								waypointType = "WeedunkWayPoint", waypointAmount = node4.getChildNode( "WeedunkWayPoint" ).getText();
					}
				}
			}
