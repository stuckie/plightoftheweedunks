...
int main( int argc, char **argv )
{
	...
	log( "Slightly pissed about with by Stuckie" );
	log( "" );
	...
	log( "Writing Lights...");
	converter->writeLights( *colladaFile,outName );
	log( "Done." );

	log ("Writing Cameras...");
	converter->writeCameras( *colladaFile,outName );
	log( "Done." );

	log ("Writing Physics...");
	converter->writePhysics( *colladaFile,outName );
	log( "Done." );

	log ("Writing Level Info...");
	converter->writeLevel( *colladaFile,outName );
	log ("Done.");
