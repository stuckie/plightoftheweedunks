...
float getNodeFloat(XMLNode& node, float default=0.0f);
bool getNodeBool(XMLNode& node, bool default=false);
string getNodeString(XMLNode& node, const string& default="");
unsigned int getNodeUInt(XMLNode& node, unsigned int default=0);
